...
<form className='w-[45%] md:w-[70%] h-[60px] bg-white flex items-center px-5 gap-5 rounded-md shadow-md ' onSubmit={(e) => e.preventDefault()} >
  <IoSearch className='text-green-500 h-[20px] w-[20px]'/>
  <input type="text" placeholder='Search items...' className='w-[100%] outline-none text-[16px] md:text-[20px]' onChange={(e)=>
